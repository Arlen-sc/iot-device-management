...
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/iot_device_management?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai
...
2. 在 `NodeHandlerRegistry` 中注册新的节点处理器
